package com.needletipson.guga.mycustomview
...
class MyCustomView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    inner class MyCustomViewAdapter(context: Context, var resource: Int, private var objects: MutableList<String>) : ArrayAdapter<String>(context, resource, objects) {
